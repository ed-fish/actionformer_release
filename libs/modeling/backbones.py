...
from .blocks import (get_sinusoid_encoding, TransformerBlock, MaskedConv1D,MaskedConv2D,
                     ConvBlock, LayerNorm)
...
@register_backbone("convTransformerVgg")
class ConvTransformerVGGBackbone(nn.Module):
    """
        A backbone that combines convolutions with transformers
    """
    def __init__(
